...
export function MeetingControlBar({
  ...
  return (
    <div className="pointer-events-auto fixed inset-x-0 bottom-0 z-50 flex justify-center px-3 pb-2">
      <div className="flex w-full max-w-6xl flex-wrap items-center justify-between gap-2 rounded-[20px] border border-slate-200 bg-white/95 px-3 py-2 shadow-[0_14px_36px_rgba(15,23,42,0.14)] backdrop-blur-xl">
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          <Button onClick={onReact} variant="secondary" size="sm" className="rounded-full border-slate-300 bg-slate-100 px-2.5 py-1.5 text-[11px] text-slate-700 hover:bg-slate-200">
            <Smile className="mr-1.5 h-3.5 w-3.5" />
            Reactions
          </Button>
          <Button onClick={onToggleRaiseHand} variant="secondary" size="sm" className={cn('rounded-full border-slate-300 bg-slate-100 px-2.5 py-1.5 text-[11px] text-slate-700 hover:bg-slate-200', hasRaisedHand && 'border-amber-400/70 bg-amber-100 text-amber-700')}>
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          <Button onClick={onToggleParticipants} variant="secondary" size="sm" className={cn('rounded-full border-slate-300 bg-slate-100 px-2.5 py-1.5 text-[11px] text-slate-700 hover:bg-slate-200', participantPanelOpen && 'border-cyan-500/60 bg-cyan-100 text-cyan-700')}>
          ...
          <details className="relative">
            <summary
              className={cn(
                'list-none cursor-pointer rounded-full border px-2.5 py-1.5 text-[11px] font-medium text-slate-700 transition hover:bg-slate-200',
          ...
          <div className="flex items-center gap-1 rounded-full border border-slate-300 bg-slate-100 p-0.5">
            {layoutOptions.map(({ mode, label, icon: Icon }) => (
              <button
                ...
                className={cn(
                  'flex items-center gap-1.5 rounded-full px-2.5 py-1.5 text-[11px] font-medium text-slate-600 transition hover:bg-white hover:text-slate-800',
          ...
          <Button onClick={onLeave} variant="destructive" size="sm" className="rounded-full px-2.5 py-1.5 text-[11px]">
